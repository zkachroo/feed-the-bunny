...
function setup() {
  ...
  rope = new Rope(7, { x: 60, y: 90 });
  rope2 = new Rope(7, { x: 400, y: 90 });

  star_display = createSprite(50,20,20,30)
  star_display.scale = 0.2
  star_display.addAnimation("empty",empty_star)
  star_display.addAnimation("emptyone",one_star)
  star_display.addAnimation("emptytwo",two_star)
  ...
  star.addImage(star_ing)
  star.scale = 0.02

  star2 = createSprite(50, 370, 20, 20)
  star2.addImage(star_ing)
  star2.scale = 0.02

  blower = createImg("baloon2.png")
  blower.position(200, 370)
  blower.size(120, 120)
...
function draw() {
  ...
  if(collide(fruit,star,20)){
    star.visible = false
    star_display.changeAnimation("emptyone")

  }

  if(collide(fruit,star2,20)){
    star2.visible = false
    star_display.changeAnimation("emptytwo")
  }
